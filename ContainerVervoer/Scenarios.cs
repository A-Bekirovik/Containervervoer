...
namespace ContainerVervoer
{
	public class Scenarios
	{
        ...
        {
            ContainerStarter containerStarter = new ContainerStarter(new Ship(6, 3));
            ...
            for (int i = 0; i < 63; i++) ContainersOnDock.Add(new Container(30, false, false));
        ...
        {
            ContainerStarter containerPlacer = new ContainerStarter(new Ship(3, 3));


            for (int i = 0; i < 25; i++) ContainersOnDock.Add(new Container(30, false, false));
